...
export default function apiClient(options = {}) {
  ...
  client.followProfile = method(
    'POST',
    `/profiles/:username/follow`,
    undefined,
    false
  );
  client.unfollowProfile = method(
    'DELETE',
    `/profiles/:username/follow`,
    undefined,
    false
  ...
  client.favoriteArticle = method(
    'POST',
    '/articles/:slug/favorite',
    undefined,
    false
  );
  client.unfavoriteArticle = method(
    'DELETE',
    '/articles/:slug/favorite',
    undefined,
    false
  ...
  client.listComments = method(
    'GET',
    '/articles/:slug/comments',
    undefined,
    true
  );
  client.createComment = method(
    'POST',
    '/articles/:slug/comments',
    undefined,
    false
  );
  client.deleteComment = method(
    'POST',
